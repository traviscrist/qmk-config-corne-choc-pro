...
The rolling history resets when the keyboard loses power and does not write to flash. On Raise, Navigate, and Function, both displays switch to per-hand references for the keys on their respective halves.
